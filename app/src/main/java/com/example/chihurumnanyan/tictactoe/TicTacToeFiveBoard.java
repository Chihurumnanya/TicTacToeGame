...
//Created by Chihurumnanya N on 28-Mar-18.

import java.util.Random;

public class TicTacToeFiveBoard {
    ...
    public int getComputerMove() {
        ...
        for (int i = 0; i < getBOARDS_SIZE(); i++) {
        ...
        do {
            move = mRand.nextInt(getBOARDS_SIZE());
    ...
    public int checkForWinner() {
        ...
        if ((mBoard[0] == PLAYER_ONE &&
                mBoard[6] == PLAYER_ONE &&
                mBoard[12] == PLAYER_ONE && mBoard[18]==PLAYER_ONE&& mBoard[24]==PLAYER_ONE) ||
                mBoard[4] == PLAYER_ONE &&
                        mBoard[8] == PLAYER_ONE &&
                        mBoard[12] == PLAYER_ONE && mBoard[16]==PLAYER_ONE&& mBoard[20]==PLAYER_ONE)
            return 2;
        if ((mBoard[0] == PLAYER_TWO &&
                mBoard[6] == PLAYER_TWO &&
                mBoard[12] == PLAYER_TWO& mBoard[18]==PLAYER_TWO&& mBoard[24]==PLAYER_TWO) ||
                mBoard[4] == PLAYER_TWO &&
                        mBoard[8] == PLAYER_TWO &&
                        mBoard[12] == PLAYER_TWO && mBoard[16]==PLAYER_TWO&& mBoard[20]==PLAYER_TWO)
            return 3;
